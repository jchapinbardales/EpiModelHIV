...
param_msm <- function(nwstats,
                      ...
                      disc.outset.pers.Y.prob = 0.8788,
                      disc.outset.pers.O.prob = 0.6494,
                      ...
                      cond.pers.YY.prob = 0.2923,
                      cond.pers.OY.prob = 0.3286,
                      cond.pers.OO.prob = 0.2363,
                      cond.inst.YY.prob = 0.2828,
                      cond.inst.OY.prob = 0.3381,
                      cond.inst.OO.prob = 0.2201,

                      #calibration scalars;
                      cond.rr.BB = 1,
                      cond.rr.BW = 1,
                      cond.rr.WW = 1,
                      cond.rr.YY = 1, #0.0, #.658, #lowest prop for Y
                      cond.rr.OY = 1, #0.0, #0.723,
                      cond.rr.OO = 1, #3.0, #0.708,
