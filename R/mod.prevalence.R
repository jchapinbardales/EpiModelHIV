    ...
    #receptive by age combo & PT;
      ...
      # among infections to young people #;
        ...
        #overall, column
          ...
          dat$epi$incid.main.Y <- rNA
          dat$epi$incid.casl.Y <- rNA
          dat$epi$incid.inst.Y <- rNA

          dat$epi$incid.OYdmain.Y <- rNA
          dat$epi$incid.YYmain.Y  <- rNA
          dat$epi$incid.OYdcasl.Y <- rNA
          dat$epi$incid.YYcasl.Y  <- rNA
          dat$epi$incid.OYdinst.Y <- rNA
          dat$epi$incid.YYinst.Y  <- rNA

          #total row
          dat$epi$incid.recpt.sus.amongY    <- rNA
          dat$epi$incid.inst.sus.amongY     <- rNA
          dat$epi$incid.stage.act.amongY    <- rNA
          dat$epi$incid.stage.chr.amongY    <- rNA
          dat$epi$incid.stage.aids.amongY   <- rNA
          dat$epi$incid.undx.amongY         <- rNA
          dat$epi$incid.notinitiated.amongY <- rNA
          dat$epi$incid.notretained.amongY  <- rNA
          dat$epi$incid.partsup.amongY      <- rNA
          dat$epi$incid.fullsup.amongY      <- rNA


        #hiv infection stage
          dat$epi$incid.stage.act.Y.Y  <- rNA
          dat$epi$incid.stage.chr.Y.Y  <- rNA
          dat$epi$incid.stage.aids.Y.Y <- rNA
          dat$epi$incid.stage.act.O.Y  <- rNA
          dat$epi$incid.stage.chr.O.Y  <- rNA
          dat$epi$incid.stage.aids.O.Y <- rNA

          dat$epi$incid.stage.act.main.Y  <- rNA
          dat$epi$incid.stage.chr.main.Y  <- rNA
          dat$epi$incid.stage.aids.main.Y <- rNA
          dat$epi$incid.stage.act.casl.Y  <- rNA
          dat$epi$incid.stage.chr.casl.Y  <- rNA
          dat$epi$incid.stage.aids.casl.Y <- rNA
          dat$epi$incid.stage.act.inst.Y  <- rNA
          dat$epi$incid.stage.chr.inst.Y  <- rNA
          dat$epi$incid.stage.aids.inst.Y <- rNA

          dat$epi$incid.stage.act.Ymain.Y  <- rNA
          dat$epi$incid.stage.chr.Ymain.Y  <- rNA
          dat$epi$incid.stage.aids.Ymain.Y <- rNA
          dat$epi$incid.stage.act.Omain.Y  <- rNA
          dat$epi$incid.stage.chr.Omain.Y  <- rNA
          dat$epi$incid.stage.aids.Omain.Y <- rNA
          dat$epi$incid.stage.act.Ycasl.Y  <- rNA
          dat$epi$incid.stage.chr.Ycasl.Y  <- rNA
          dat$epi$incid.stage.aids.Ycasl.Y <- rNA
          dat$epi$incid.stage.act.Ocasl.Y  <- rNA
          dat$epi$incid.stage.chr.Ocasl.Y  <- rNA
          dat$epi$incid.stage.aids.Ocasl.Y <- rNA
          dat$epi$incid.stage.act.Yinst.Y  <- rNA
          dat$epi$incid.stage.chr.Yinst.Y  <- rNA
          dat$epi$incid.stage.aids.Yinst.Y <- rNA
          dat$epi$incid.stage.act.Oinst.Y  <- rNA
          dat$epi$incid.stage.chr.Oinst.Y  <- rNA
          dat$epi$incid.stage.aids.Oinst.Y <- rNA

          #hiv care stage
          dat$epi$incid.undx.Y.Y         <- rNA
          dat$epi$incid.notinitiated.Y.Y <- rNA
          dat$epi$incid.notretained.Y.Y  <- rNA
          dat$epi$incid.partsup.Y.Y      <- rNA
          dat$epi$incid.fullsup.Y.Y      <- rNA
          dat$epi$incid.undx.O.Y         <- rNA
          dat$epi$incid.notinitiated.O.Y <- rNA
          dat$epi$incid.notretained.O.Y  <- rNA
          dat$epi$incid.partsup.O.Y      <- rNA
          dat$epi$incid.fullsup.O.Y      <- rNA

          dat$epi$incid.undx.main.Y         <- rNA
          dat$epi$incid.notinitiated.main.Y <- rNA
          dat$epi$incid.notretained.main.Y  <- rNA
          dat$epi$incid.partsup.main.Y      <- rNA
          dat$epi$incid.fullsup.main.Y      <- rNA
          dat$epi$incid.undx.casl.Y         <- rNA
          dat$epi$incid.notinitiated.casl.Y <- rNA
          dat$epi$incid.notretained.casl.Y  <- rNA
          dat$epi$incid.partsup.casl.Y      <- rNA
          dat$epi$incid.fullsup.casl.Y      <- rNA
          dat$epi$incid.undx.inst.Y         <- rNA
          dat$epi$incid.notinitiated.inst.Y <- rNA
          dat$epi$incid.notretained.inst.Y  <- rNA
          dat$epi$incid.partsup.inst.Y      <- rNA
          dat$epi$incid.fullsup.inst.Y      <- rNA

          dat$epi$incid.undx.Ymain.Y         <- rNA
          dat$epi$incid.notinitiated.Ymain.Y <- rNA
          dat$epi$incid.notretained.Ymain.Y  <- rNA
          dat$epi$incid.partsup.Ymain.Y      <- rNA
          dat$epi$incid.fullsup.Ymain.Y      <- rNA
          dat$epi$incid.undx.Omain.Y         <- rNA
          dat$epi$incid.notinitiated.Omain.Y <- rNA
          dat$epi$incid.notretained.Omain.Y  <- rNA
          dat$epi$incid.partsup.Omain.Y      <- rNA
          dat$epi$incid.fullsup.Omain.Y      <- rNA
          dat$epi$incid.undx.Ycasl.Y         <- rNA
          dat$epi$incid.notinitiated.Ycasl.Y <- rNA
          dat$epi$incid.notretained.Ycasl.Y  <- rNA
          dat$epi$incid.partsup.Ycasl.Y      <- rNA
          dat$epi$incid.fullsup.Ycasl.Y      <- rNA
          dat$epi$incid.undx.Ocasl.Y         <- rNA
          dat$epi$incid.notinitiated.Ocasl.Y <- rNA
          dat$epi$incid.notretained.Ocasl.Y  <- rNA
          dat$epi$incid.partsup.Ocasl.Y      <- rNA
          dat$epi$incid.fullsup.Ocasl.Y      <- rNA
          dat$epi$incid.undx.Yinst.Y         <- rNA
          dat$epi$incid.notinitiated.Yinst.Y <- rNA
          dat$epi$incid.notretained.Yinst.Y  <- rNA
          dat$epi$incid.partsup.Yinst.Y      <- rNA
          dat$epi$incid.fullsup.Yinst.Y      <- rNA
          dat$epi$incid.undx.Oinst.Y         <- rNA
          dat$epi$incid.notinitiated.Oinst.Y <- rNA
          dat$epi$incid.notretained.Oinst.Y  <- rNA
          dat$epi$incid.partsup.Oinst.Y      <- rNA
          dat$epi$incid.fullsup.Oinst.Y      <- rNA

          #positioning
          dat$epi$incid.recpt.sus.Y.Y     <- rNA
          dat$epi$incid.inst.sus.Y.Y      <- rNA
          dat$epi$incid.recpt.sus.O.Y     <- rNA
          dat$epi$incid.inst.sus.O.Y      <- rNA

          dat$epi$incid.recpt.sus.main.Y  <- rNA
          dat$epi$incid.inst.sus.main.Y   <- rNA
          dat$epi$incid.recpt.sus.casl.Y  <- rNA
          dat$epi$incid.inst.sus.casl.Y   <- rNA
          dat$epi$incid.recpt.sus.inst.Y  <- rNA
          dat$epi$incid.inst.sus.inst.Y   <- rNA

          dat$epi$incid.recpt.sus.Ymain.Y <- rNA
          dat$epi$incid.inst.sus.Ymain.Y  <- rNA
          dat$epi$incid.recpt.sus.Omain.Y <- rNA
          dat$epi$incid.inst.sus.Omain.Y  <- rNA
          dat$epi$incid.recpt.sus.Ycasl.Y <- rNA
          dat$epi$incid.inst.sus.Ycasl.Y  <- rNA
          dat$epi$incid.recpt.sus.Ocasl.Y <- rNA
          dat$epi$incid.inst.sus.Ocasl.Y  <- rNA
          dat$epi$incid.recpt.sus.Yinst.Y <- rNA
          dat$epi$incid.inst.sus.Yinst.Y  <- rNA
          dat$epi$incid.recpt.sus.Oinst.Y <- rNA
          dat$epi$incid.inst.sus.Oinst.Y  <- rNA
