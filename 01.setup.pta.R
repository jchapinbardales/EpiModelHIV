...
#Y=18-24
#O=25-40
rates.main.age <- mean(c(0.00787667250636301,  #YYMAIN
                         0.00285833888890699,  #YOMAIN
                         0.00182407152778933)) #OOMAIN
rates.pers.age <- mean(c(0.00682903626167434,  #YYCAS
                         0.00835117085011982,  #YOCAS
                         0.00572848909553674)) #OOCAS

durs.main.age <- 1/rates.main.age  ## should be log2/rates.main.age if separated by age?
durs.pers.age <- 1/rates.pers.age  ## should be log2/rates.main.age if separated by age?

#=mean of median durations across ages, one duration for main, one duration for casual;
#durs.main.age=238.8709 (YY 126, YO|OY 349, OO 548)
#durs.pers.age=143.481 (YY 146, YO|OY 119, OO 174)
...
save(st, file = "C:\Users\jchapi2\Documents\GitHub\EpiModelHIV\est\nwstats.rda") #("est/nwstats.rda")
rm(list = ls()) 
